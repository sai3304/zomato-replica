            ...
            <div className="app-header">
                ...
                { isLoggedIn ? <div style={{ float: 'right', display: 'inline-block' }}>
                    ...
                    <div style={{ float: 'right', display: 'inline-block' }}>
                        ...
                        <div style={{ display: 'inline-block' }} className="signUp login" onClick={this.handlesignUp}>Create an account</div>
                    </div>}
                <Modal
                ...
                >
                    <div>
                        ...
                        <div>
                            <GoogleLogin
                                clientId="37720882748-qqtpjqkbain6rj2285lirqrrjf9rocvf.apps.googleusercontent.com"
