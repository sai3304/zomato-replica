...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'GET',
            url: `http://localhost:2022/getResById/${resId}`,
    ...
    buildForm = ({ action, params}) => {
        ...
        Object.keys(params).forEach(key => {
            ...
            input.setAttribute('value', this.stringfiyValue(params[key]))
    ...
    render() {
        ...
        return (<div>
            <div>
                <img src={"Assets/breakfast.png"} alt="No Image, Sorry for the Inconvinience" width="100%" height="300px" />
                <button className="button" onClick={() => this.handleModal('galleryModalIsOpen', true)}>Click to see Image Gallery</button>
            </div>
            <div className="heading2">{restaurant.name}</div>
            ...
            >
                ...
                <div className="resName">
                  ...
                  <input className="form-control form-control-lg" style={{ width: '350px'}} type="text" placeholder="Enter your mobile numbe" onChange={(event) => this.handleChange(event, 'mobileNumber')} />
